...
<view>
      ...
      <view>
          ...
          <view class="tr">
            <view class="td" v-for="(item,index) in monthData.top.click" :key="index">
              <view v-if="index== '1'">
          ...
          <view class="tr">
            <view class="td" v-for="(item,index) in monthData.top.time" :key="index">
              <view v-if="index== '1'">
              <image class="topnum" src="https://6e69-niuwa-js2i2-1300106435.tcb.qcloud.la/img/llbg/TOP2.png?sign=fa8a7374b9438955b7311c5266faabf8&t=1567062449"/>
              </view>
               <view  v-else-if="index=='0'">
          ...
          <view class="tr">
            <view class="td" v-for="(item,index) in monthData.top.flag" :key="index">
              <view v-if="index== '1'">
              <image class="topnum" src="https://6e69-niuwa-js2i2-1300106435.tcb.qcloud.la/img/llbg/TOP2.png?sign=fa8a7374b9438955b7311c5266faabf8&t=1567062449"/>
              </view>
               <view  v-else-if="index=='0'">
      ...
      <view>
          ...
          <view class="dpbd">孩子平均上网时间：<span class="llwztitile">{{monthData.dayTimeStr}}</span></view><br/>
          <view class="dpbd">
          ...
          <view class="dpbd">孩子上网偏向：<span class="llwztitile">{{monthData.like}}</span></view><br/>
	...
	methods:{
		getServerData(deviceid){
			let that=this,lineData;
			  uni.request({
			  url: that.url+'web/api/findHistoryReportMonth',
			  header: {
			  ...
			  success: function(res){
			    ...
			    let lineD=res.data.zheXian;
			    let o=[];
			    o[0]=lineD.findTime01_10;o[1]=lineD.findTime11_20;o[2]=lineD.findTime21_30;
			  lineData=o;
			  asdasda.data=lineData;
			  asdasda.name="每天的上网时长";
			  LineA.categories=['上旬', '中旬', '下旬']
